...
class BaseOptions():
    ...
    def initialize(self):    
        # experiment specifics实验细节
        self.parser.add_argument('--name', type=str, default='84shadow+closs-attention-res-multi-jiaozhun', help='name of the experiment. It decides where to store samples and models')
        ...
        ################################################################################################################################  
        self.parser.add_argument('--norm_DD', type=str, default='spectralinstance', help='instance normalization or batch normalization') 
        ################################################################################################################################  
